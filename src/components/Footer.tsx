...
import Categories from './FooterBrands'
...
const Address = () => {
    return (
        <div className='flex flex-col gap-2 basis-[33%]'>
            ...
            <h1 className='font-bold'>Zarkkash</h1>
            <p className='flex items-start gap-2'> <MapPin /> 2nd Floor Aries Tower, Maryam Hall, Shamsabad, Rawalpindi</p>
            <p className='flex items-start gap-2'> <Mail />zarkashcollection12@gmail.com</p>
            <p className='font-bold'>Whatsapp Chat Support <br /> (10 am to 5 pm MON to SAT) Only Chat</p>
            <p className='flex items-start gap-2'> <Phone />+92 346 5857969</p>
    ...
    return (
        <div className='flex flex-col gap-2 basis-[33%]'>
            ...
            <label htmlFor="newsLetter" className='border rounded-full pl-4 -2 flex justify-between'>
                <input type="email" placeholder='Your email address' name='newsLetter' id='newsLetter' className='outline-none bg-transparent' />
