...
const CreateProductPage = () => {
    ...
    const variantsField = {
        ...
        fields: [
            { name: "dialColor", placeholder: "Dial Color", type: "color", validations: { required: "Dial Color is required" } },
            { name: "strapColor", placeholder: "Strap Color", type: "color", validations: { required: "Strap Color is required" } },
